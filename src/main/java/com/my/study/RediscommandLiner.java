...
@Component
public class RediscommandLiner implements CommandLineRunner {

	private static Log logger = LogFactory.getLog(RediscommandLiner.class);

	private final StringRedisTemplate template;

	private final SlowService service;

	public RediscommandLiner(StringRedisTemplate template, SlowService service) {
